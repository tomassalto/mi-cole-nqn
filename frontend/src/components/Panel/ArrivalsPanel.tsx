...
export default function ArrivalsPanel() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex max-h-[82vh] flex-col overflow-hidden rounded-t-[28px] border border-white/70 bg-white/90 shadow-[0_-24px_60px_rgba(15,23,42,0.16)] backdrop-blur-xl md:bottom-4 md:left-4 md:right-auto md:top-[72px] md:w-[380px] md:rounded-[28px] md:shadow-[0_24px_60px_rgba(15,23,42,0.14)] lg:w-[480px]">
      <div className="mx-auto my-2 h-1.5 w-14 rounded-full bg-slate-200 md:hidden" />
      <div className="flex items-start justify-between border-b border-slate-200/80 px-4 pb-3 pt-4">
        ...
        <>
          ...
          <div className="border-t border-slate-200/80 p-4">
            <button
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-50"
            >
              ¿A qué hora llego a otra parada?
            </button>
            <button
              onClick={openConsultation}
              className="mt-2 w-full rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-emerald-800 transition-colors hover:bg-emerald-100"
            >
